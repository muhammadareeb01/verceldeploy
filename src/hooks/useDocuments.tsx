...
// This is just a small part of the file to fix the error with document types query
...
export const documentKeys = {
  ...
  documentTypesByService: (serviceId?: string | string[]) => 
    [...documentKeys.documentTypes(), serviceId] as const,
 ...
 */
export const useDocumentTypesQuery = (filters?: { serviceId?: string | string[] }) => {
  return useQuery<DocumentType[], Error>({
    queryKey: filters?.serviceId ? documentKeys.documentTypesByService(filters.serviceId) : documentKeys.documentTypes(),
    queryFn: async () => {
